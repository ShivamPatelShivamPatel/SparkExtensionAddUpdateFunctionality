## Add support for Implementing Updates as Queries to Spark via simple API using internal methods.  As well for certain classes of updates of the form a -> f(a) + X and a -> f(a) * X, added custom rules in Optimizer class in Optimizer.scala to decrease references to a in Projection optimizations. Forked from original
